...
import org.neutron.microedition.ImplementationUnloadable;
import org.neutron.microedition.io.ConnectorAdapter;
...
public class FileSystemConnectorImpl extends ConnectorAdapter implements ImplementationUnloadable {
	...
	public final static String PROTOCOL = org.neutron.cldc.file.Connection.PROTOCOL;
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.neutron.microedition.ImplementationUnloadable#unregisterImplementation()
	 */
