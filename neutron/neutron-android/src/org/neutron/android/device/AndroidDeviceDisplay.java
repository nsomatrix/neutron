...
import org.neutron.android.device.ui.AndroidCanvasUI.CanvasView;
...
public class AndroidDeviceDisplay implements DeviceDisplay {
	...
	public void setSize(int width, int height) {
		if (NeutronActivity.config.ORIG_DISPLAY_FIXED) {
	        displayRectangleWidth = NeutronActivity.config.ORIG_DISPLAY_WIDTH;
	        displayRectangleHeight = NeutronActivity.config.ORIG_DISPLAY_HEIGHT;
		} else {
	        displayRectangleWidth = (int) (width * (NeutronActivity.config.CANVAS_AREA_RIGHT - NeutronActivity.config.CANVAS_AREA_LEFT));
	        displayRectangleHeight = (int) (height * (NeutronActivity.config.CANVAS_AREA_BOTTOM - NeutronActivity.config.CANVAS_AREA_TOP));
		}
	}
