 ...
 *  limitations.
 *
 *  @version $Id: AndroidCustomItemUI.java 1918 2009-01-21 12:56:43Z neutron $
 */
...
public class AndroidCustomItemUI extends LinearLayout implements CustomItemUI {
	...
	public AndroidCustomItemUI(final NeutronActivity activity, final CustomItemAccess customItemAccess) {
		super(activity);
