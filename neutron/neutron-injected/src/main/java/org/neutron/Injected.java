 ...
 * 
 * You need to use "Save for Web..." in Neutron Tools Menu.
 * The result jar is safe to run on any other Emulator or device. 
 * 
 * This class is not used while application is running in Applet with Neutron. 
 * Different class with the same name is used from neutron-javase-applet.jar.    
 */
