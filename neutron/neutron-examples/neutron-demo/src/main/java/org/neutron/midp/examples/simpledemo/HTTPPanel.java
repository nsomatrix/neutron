 ...
 *  @version $Id$
 */
package org.neutron.midp.examples.simpledemo;
...
public class HTTPPanel extends BaseExamplesForm {
	...
	public HTTPPanel() {
		...
		String host = SimpleDemoMIDlet.instance.getAppProperty("neutron.accessible.host");
		if (host == null) {
			demoLocation = "http://www.neutron.org/test/";
		} else {
