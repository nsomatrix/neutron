...
public class IPhoneTextBoxUI extends AbstractUI<TextBox> implements TextBoxUI {
	...
	public IPhoneTextBoxUI(Neutron neutronlator, TextBox textBox) {
		super(neutronlator, textBox);
	...
	public void showNotify() {
		...
		if (view == null) {
			...
			}.initWithFrame$(new CGRect(0, NAVIGATION_HEIGHT, neutronlator.getWindow().bounds().size.width, neutronlator
